...
--==================================================
    ...
    function WindowObject:ShowConfirmation(Options)
        Options = Options or {}
        ...
        Create("UIStroke", { Parent = Dialog, Color = Theme.Border, Thickness = 1 })
        ...
        MakeButton(CancelText,  Theme.Border,                135, OnCancel)
    end
